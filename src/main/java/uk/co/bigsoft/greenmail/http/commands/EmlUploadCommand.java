...
public class EmlUploadCommand extends BaseHandler {

    public EmlUploadCommand(GreenMail greenMail) {
        super(greenMail);
    }

    @Override
    public void handle(Context ctx) throws Exception {
        ServerSetup setup = new ServerSetup(gm.getSmtp().getPort(), "localhost", ServerSetup.PROTOCOL_SMTP);
